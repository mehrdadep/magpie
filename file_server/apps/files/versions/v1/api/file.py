...
from file_server.apps.files.versions.v1.services.file import (
    FileService,
)
from file_server.core.permissions import (
    FileAPIUserPermission,
)
from file_server.core.response import response


class FilesAPIView(APIView):
    permission_classes = (FileAPIUserPermission,)
